...
export default function SendTransaction() {
  ...
  return (
    ...
    <div id= "transaction" className="flex flex-col gap-8 max-w-[768px] mx-auto min-h-screen items-center justify-center">
      <h2  className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-5xl">Send Transaction</h2>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className="w-full md:w-[400px]"  placeholder="0xA0Cf…251e" {...field} />
                </FormControl>
