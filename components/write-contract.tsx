...
export default function WriteContract() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen"> {/* Centering container */}
      <div className="flex flex-col gap-6 w-full max-w-md"> {/* Main content container */}
      <h2 className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-5xl">Write Contract</h2>
      <Form {...form}>
