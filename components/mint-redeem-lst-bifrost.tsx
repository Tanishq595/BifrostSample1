...
export default function MintRedeemLstBifrost() {
  ...
  return (
    <div id="mint" className="flex items-center justify-center min-h-screen pt-10"> {/* Added padding-top */}
    <div className="flex flex-col items-center"> {/* Center the content vertically */}
      <h2  className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-5xl mb-10"> {/* Increased margin-bottom */}
